...
<table style="width: 100%; margin: 0 auto; border-collapse: collapse;">
    ...
    <div style="font-size: 13px; display: flex; justify-content: space-between;">
        ...
        <strong>Controles completos:</strong> {{ $controlCompleto->count() }}<br>
        <strong>Controles incompletos:</strong> {{ $controlIncompleto->count() }}<br>
        ...
        <tbody>
            @foreach ($controles as $control)
                <tr>
                    ...
                    @if ($control->statusCumplimiento == 'Sí')
