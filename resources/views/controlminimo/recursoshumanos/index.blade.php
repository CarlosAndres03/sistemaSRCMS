        ...
        <div class="col-md-12">
            <div class="card" style="width: 80rem;">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('filtrar.informacionR') }}">
                        @csrf
                        <div class="col-md-3">
                            ...
                            <a class="btn btn-sm btn-success" href="{{route('rh.index')}}"
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a class="btn btn-success" href="{{route('rh.create')}}"><i class="fa fa-plus">
                                Nuevo</i></a>
                    </div>
                    @endcan
                    <br>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center"><a class="btn btn-sm btn-info"
                                            href="{{ route('rh.edit', $control->idControlMinimo)}}"><i
                                                class="fa fa-edit"></i></a>
                                                @can('editar-control mínimo')
                                        <form action="{{ route('rh.destroy', $control->idControlMinimo) }}"
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div style="display: flex; justify-content: space-between; width: 80rem;">
                <a class="btn btn-success" href="{{ route('gestion.index') }}" style="display: inline-block; float: right;">
                <i class="fa fa-solid fa-arrow-left"></i> Regresar 
                </a>
                <a class="btn btn-success" href="{{ route('equipos-fisicos.index') }}" style="display: inline-block; float: left;">
