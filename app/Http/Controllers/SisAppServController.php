...
class SisAppServController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $archivosFaltantes = 17 - $archivosSubidos;
    
        return view('controlminimo.sisappserv.index', compact('controles', 'porcentajeCumplimiento', 'archivosSubidos', 'archivosFaltantes','year','semester'));
    }

    public function create(Request $request)
    {
        return view('controlminimo.sisappserv.create');
    }
    public function store(Request $request)
    {
        ...
        $controlminimo->idEtapaTecnologica = 9;
        $user = auth()->id();
        ...
        $controlminimo->save();
        return redirect()->route('sis-app-serv.index');
    ...
    public function edit(string $id)
    {
        ...
        return view('controlminimo.sisappserv.edit', compact('control', 'years'));
    }
    ...
    public function filtrar(Request $request)
    {
        ...
        $porcentajeCumplimiento = ($totalCompleto / $totalControles) * 100;
        $archivosSubidos = $controles->where('documentoEvidencia')->where('idEtapaTecnologica', 9)->count();
        ...
        $controlesFiltrados = ControlMinimo::where('semestre', $semestreSeleccionado)->where('idEtapaTecnologica', 9)->get();

        return view('controlminimo.sisappserv.index', ['controles' => $controlesFiltrados], compact('controles', 'controlCompleto', 'controlIncompleto', 'porcentajeCumplimiento', 'archivosSubidos', 'archivosFaltantes'));
    }
    ...
    public function generarPDF(Request $request)
{
    ...
    public function anios()
    {
        ...
        return view('controlminimo.sisappserv.anios', compact('years'));
    }
}