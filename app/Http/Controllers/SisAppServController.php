    ...
    public function index()
{
    ...
    return view('controlminimo.sisappserv.index', compact('controles', 'controlCompleto', 'controlIncompleto', 'porcentajeCumplimiento','archivosSubidos','archivosFaltantes'));
    ...
    public function edit(string $id){
        ...
        return view('controlminimo.sisappserv.edit', compact('control'));
    }
    public function update(Request $request, $id){
        $control = ControlMinimo::find($id);
        $control->idEtapaTecnologica = 9;
        $user = auth()->id();
        ...
        $control->save();
        return redirect()->to(url('/sis-app-serv'));
    }
