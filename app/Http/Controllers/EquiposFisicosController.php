...
class EquiposFisicosController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $archivosFaltantes = 3 - $archivosSubidos;
    
        return view('controlminimo.equiposfisicos.index', compact('controles', 'porcentajeCumplimiento', 'archivosSubidos', 'archivosFaltantes','year','semester'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('controlminimo.equiposfisicos.edit', compact('control', 'years'));
    }
    ...
    public function generarPDF(Request $request)
{
    ...
    public function anios()
    {
        ...
        return view('controlminimo.equiposfisicos.anios', compact('years'));
    }
}