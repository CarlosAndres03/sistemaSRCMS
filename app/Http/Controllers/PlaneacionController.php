    ...
    public function index()
{
    ...
    return view('controlminimo.planeacion.index', compact('controles', 'controlCompleto', 'controlIncompleto', 'porcentajeCumplimiento','archivosSubidos','archivosFaltantes'));
    ...
    public function edit(string $id){
        ...
        return view('controlminimo.planeacion.edit', compact('control'));
    }
    public function update(Request $request, $id){
        $control = ControlMinimo::find($id);
        $control->idEtapaTecnologica = 1;
        $user = auth()->id();
        ...
        $control->save();
        return redirect()->to(url('/planeacion'));
    }
