...
class TecnologiaMovilController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('controlminimo.tecmovil.index', compact('controles', 'porcentajeCumplimiento', 'archivosSubidos', 'archivosFaltantes','year','semester'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('controlminimo.tecmovil.edit', compact('control', 'years'));
    }
    ...
    public function generarPDF(Request $request)
{
    ...
    public function anios()
    {
        ...
        return view('controlminimo.tecmovil.anios', compact('years'));
    }
}