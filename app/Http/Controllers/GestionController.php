...
class GestionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('controlminimo.gestion.index', compact('controles', 'porcentajeCumplimiento', 'archivosSubidos', 'archivosFaltantes','year','semester'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('controlminimo.gestion.edit', compact('control', 'years'));
    }
    ...
    public function generarPDF(Request $request)
{
    ...
    public function anios()
    {
        ...
        return view('controlminimo.gestion.anios', compact('years'));
    }
}