    ...
    public function index()
{
    ...
    $archivosSubidos = $controles->where('documentoEvidencia')->where('idEtapaTecnologica', 2)->count();
    $archivosFaltantes = 17 - $archivosSubidos;// Cambia 100 por el número total esperado de archivos
    return view('controlminimo.gestion.index', compact('controles', 'controlCompleto', 'controlIncompleto', 'porcentajeCumplimiento','archivosSubidos','archivosFaltantes'));
    
}
    public function create(Request $request)
    {
        return view ('controlminimo.gestion.create');
    }
    public function store(Request $request)
    {
        ...
        $controlminimo->idEtapaTecnologica = 2;
        $user = auth()->id();
    ...
    public function edit(string $id){
        ...
        return view('controlminimo.gestion.edit', compact('control'));
    }
    public function update(Request $request, $id){
        $control = ControlMinimo::find($id);
        $control->idEtapaTecnologica = 2;
        $user = auth()->id();
        ...
        $control->save();
        return redirect()->to(url('/gestion'));
    }
    ...
    $archivosFaltantes = 17 - $archivosSubidos;// Cambia 100 por el número total esperado de archivos
        ...
        $controlesFiltrados = ControlMinimo::where('semestre', $semestreSeleccionado)->where('idEtapaTecnologica', 2)->get();

        return view('controlminimo.gestion.index', ['controles' => $controlesFiltrados], compact('controles', 'controlCompleto', 'controlIncompleto', 'porcentajeCumplimiento', 'archivosSubidos', 'archivosFaltantes'));
    }
