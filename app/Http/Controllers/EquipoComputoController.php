...
class EquipoComputoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $archivosFaltantes = 13 - $archivosSubidos;
    
        return view('controlminimo.equipocomputo.index', compact('controles', 'porcentajeCumplimiento', 'archivosSubidos', 'archivosFaltantes','year','semester'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $controlminimo->save();
        return redirect()->route('equipocomputo.index');
    ...
    public function edit(string $id)
    {
        ...
        return view('controlminimo.equipocomputo.edit', compact('control', 'years'));
    }
    ...
    public function generarPDF(Request $request)
{
    ...
    public function anios()
    {
        ...
        return view('controlminimo.equipocomputo.anios', compact('years'));
    }
}