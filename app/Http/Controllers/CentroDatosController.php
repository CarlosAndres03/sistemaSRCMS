...
class CentroDatosController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('controlminimo.centrodatos.index', compact('controles', 'porcentajeCumplimiento', 'archivosSubidos', 'archivosFaltantes','year','semester'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('controlminimo.centrodatos.edit', compact('control', 'years'));
    }
    ...
    public function generarPDF(Request $request)
{
    ...
    public function anios()
    {
        ...
        return view('controlminimo.centrodatos.anios', compact('years'));
    }
}