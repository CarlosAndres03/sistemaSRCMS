    ...
    public function index()
{
    ...
    $archivosSubidos = $controles->where('documentoEvidencia')->where('idEtapaTecnologica', 5)->count();
    $archivosFaltantes = 7 - $archivosSubidos;// Cambia 100 por el número total esperado de archivos
    return view('controlminimo.centrodatos.index', compact('controles', 'controlCompleto', 'controlIncompleto', 'porcentajeCumplimiento','archivosSubidos','archivosFaltantes'));
    
}
    public function create(Request $request)
    {
        return view ('controlminimo.centrodatos.create');
    }
    public function store(Request $request)
    {
        ...
        $controlminimo->idEtapaTecnologica = 5;
        $user = auth()->id();
        ...
        $controlminimo->save();
        return redirect()->route('centro-datos.index');
    ...
    public function edit(string $id){
        ...
        return view('controlminimo.centrodatos.edit', compact('control'));
    }
    public function update(Request $request, $id){
        $control = ControlMinimo::find($id);
        $control->idEtapaTecnologica = 5;
        $user = auth()->id();
        ...
        $control->save();
        return redirect()->to(url('/centro-datos'));
    }
    ...
    $archivosFaltantes = 7 - $archivosSubidos;// Cambia 100 por el número total esperado de archivos
        ...
        $controlesFiltrados = ControlMinimo::where('semestre', $semestreSeleccionado)->where('idEtapaTecnologica', 5)->get();

        return view('controlminimo.centrodatos.index', ['controles' => $controlesFiltrados], compact('controles', 'controlCompleto', 'controlIncompleto', 'porcentajeCumplimiento', 'archivosSubidos', 'archivosFaltantes'));
    }
