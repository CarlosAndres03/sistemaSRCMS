...
class BDController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $archivosFaltantes = 6 - $archivosSubidos;
    
        return view('controlminimo.bd.index', compact('controles', 'porcentajeCumplimiento', 'archivosSubidos', 'archivosFaltantes','year','semester'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('controlminimo.bd.edit', compact('control', 'years'));
    }
    ...
    public function generarPDF(Request $request)
{
    ...
    public function anios()
    {
        ...
        return view('controlminimo.bd.anios', compact('years'));
    }
}