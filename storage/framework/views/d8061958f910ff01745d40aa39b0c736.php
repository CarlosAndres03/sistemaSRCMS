...
<table style="width: 100%; margin: 0 auto; border-collapse: collapse;">
    ...
    <div style="font-size: 13px; display: flex; justify-content: space-between;">
        ...
        <strong>Controles completos:</strong> <?php echo e($controlCompleto->count()); ?><br>
        <strong>Controles incompletos:</strong> <?php echo e($controlIncompleto->count()); ?><br>
    ...
    <img src="<?php echo e($rutaImagen); ?>" alt="Gráfico de Cumplimiento" style="max-width: 900px; max-height: 245px; margin-bottom: 25px;">
    <div class="footer">
...
<?php /**PATH /var/www/sistemaSRCMS/P-SRCMS/resources/views/controlminimo/reportepdf.blade.php ENDPATH**/ ?>