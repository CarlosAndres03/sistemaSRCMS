    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card" style="width: 60rem;">
                <h1 class="card-header">Planeacion</h1>
                <div class="card-body">
                    ...
                    <?php echo Form::model($control, ['method'=>'PATCH', 'files' => true, 'route' => ['planeacion.update',
...
<?php echo $__env->make('layouts.vistaadministrador', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sistemaSRCMS/P-SRCMS/resources/views/controlminimo/planeacion/edit.blade.php ENDPATH**/ ?>