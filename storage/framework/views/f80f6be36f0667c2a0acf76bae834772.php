            ...
            <div class="card" style="width: 80rem;">
                ...
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a class="btn btn-success" href="<?php echo e(route('planeacion.create')); ?>"><i class="fa fa-plus">
                                Nuevo</i></a>
                    </div>
                    <?php endif; ?>
                    <br>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center"><a class="btn btn-sm btn-info"
                                            href="<?php echo e(route('planeacion.edit', $control->idControlMinimo)); ?>"><i
                                                class="fa fa-edit"></i></a>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar-control mínimo')): ?>
                                        <form action="<?php echo e(route('planeacion.destroy', $control->idControlMinimo)); ?>"
            ...
            <div class="card" style="width: 80rem;">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar-control mínimo')): ?>
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        ...
                        </h5><br><a class="btn btn-success" href="/generar-reporte"><i class="fa fa-download"></i></a>
                    </div>
                    <?php endif; ?>
                    <div class="container">
                        <div class="row justify-content-center">
...
<?php echo $__env->make('layouts.vistaadministrador', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sistemaSRCMS/P-SRCMS/resources/views/controlminimo/planeacion/index.blade.php ENDPATH**/ ?>