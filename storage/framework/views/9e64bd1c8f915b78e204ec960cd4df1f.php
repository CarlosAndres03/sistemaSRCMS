        ...
        <div class="col-md-12">
            <div class="card" style="width: 80rem;">
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form method="POST" action="<?php echo e(route('filtrar.informacionS')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="col-md-3">
                            ...
                            <a class="btn btn-sm btn-success" href="<?php echo e(route('sis-app-serv.index')); ?>"
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a class="btn btn-success" href="<?php echo e(route('sis-app-serv.create')); ?>"><i class="fa fa-plus">
                                Nuevo</i></a>
                    </div>
                    <?php endif; ?>
                    <br>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center"><a class="btn btn-sm btn-info"
                                            href="<?php echo e(route('sis-app-serv.edit', $control->idControlMinimo)); ?>"><i
                                                class="fa fa-edit"></i></a>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar-control mínimo')): ?>
                                        <form action="<?php echo e(route('sis-app-serv.destroy', $control->idControlMinimo)); ?>"
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card" style="width: 80rem;">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar-control mínimo')): ?>
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        ...
                        </h5><br><a class="btn btn-success" href="/generar-reporteS"><i class="fa fa-download"></i></a>
                    </div>
                    <?php endif; ?>
                    <div class="container">
                        <div class="row justify-content-center">
            ...
            <div style="display: flex; justify-content: space-between; width: 80rem;">
                <a class="btn btn-success" href="<?php echo e(route('tec-movil.index')); ?>" style="display: inline-block; float: right;">
                <i class="fa fa-solid fa-arrow-left"></i> Regresar 
                </a>
                <a class="btn btn-success" href="<?php echo e(route('bd.index')); ?>" style="display: inline-block; float: left;">
...
<?php echo $__env->make('layouts.vistaadministrador', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sistemaSRCMS/P-SRCMS/resources/views/controlminimo/sisappserv/index.blade.php ENDPATH**/ ?>